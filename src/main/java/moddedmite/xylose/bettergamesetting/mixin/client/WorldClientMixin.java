...
//	}
//
//	@WrapOperation(method = "playLongDistanceSound", at = @At(value = "INVOKE", target = "Lnet/minecraft/SoundManager;func_92070_a(Ljava/lang/String;FFFFFI)V"))
//	private void replaceLongDistanceSoundManager(SoundManager instance, String sound, float x, float y, float z, float volume, float pitch, int distanceDelay, Operation<Void> original) {
// 		this.mc.getSoundHandler().playDelayedSound(new PositionedSoundRecord(new SoundEvent(new ResourceLocation(sound), SoundCategory.MASTER), SoundCategory.MASTER, volume, pitch, x, y, z), distanceDelay);
//	}
//
//	@WrapOperation(method = "playLongDistanceSound", at = @At(value = "INVOKE", target = "Lnet/minecraft/SoundManager;playLongDistanceSound(Ljava/lang/String;FFFFF)V"))
//	private void replaceLongDistanceSoundManager(SoundManager instance, String sound, float x, float y, float z, float volume, float pitch, Operation<Void> original) {
//		this.mc.getSoundHandler().playSound(new PositionedSoundRecord(new SoundEvent(new ResourceLocation(sound), SoundCategory.MASTER), SoundCategory.MASTER, volume, pitch, x, y, z));
//	}
}
