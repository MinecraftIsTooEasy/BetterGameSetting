...
import net.minecraft.GuiScreenTemporaryResourcePackSelect;
import net.minecraft.GuiScreenTemporaryResourcePackSelectSelectionList;
...
public abstract class GuiScreenTemporaryResourcePackSelectSelectionListMixin extends GuiSlot {
	@Shadow private final ResourcePackRepository field_110511_b;
	@Shadow final GuiScreenTemporaryResourcePackSelect field_110512_a;
